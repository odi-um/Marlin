...
#define STRING_CONFIG_H_AUTHOR "@brandstaetter, @grbd, @odi-um" // Who made the changes.
 ...
 */
// I have to use the standalone version because I have old drivers.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 89.03
  #define DEFAULT_bedKi 16.13
  #define DEFAULT_bedKd 327.64
